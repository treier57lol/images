...
RUN         dpkg --add-architecture i386 \
            ...
            && apt-get install -y libnss-wrapper gettext-base tar curl gcc g++ libc6 libtbb2 lib32gcc1 lib32stdc++6 libtbb2:i386 lib32z1 lib32stdc++6 libtinfo5:i386 libncurses5:i386 libcurl3-gnutls:i386 \
